...
function [tail,cross, distance] = averageProfile(waypoints, start_alt, end_alt, date)
    ...
    [points]= pyrunfile(filePath, 'points', waypoints = pyWaypoints);
    ...
    for i = 1:length(distance)
        ...
        for k = 0:49
            ...
            currentDateIndex = dateIndex - year_index - days_index;

            [tail_partial,cross_partial] = getWind2(longitudes(i), latitudes(i), unitx(i), unity(i), alt, currentDateIndex);
